...
/**
 * Creates a ball object with randomized x-position, default y-position,
 * default size, and randomized velocity
*/
function createBall() {
    let ball = {
